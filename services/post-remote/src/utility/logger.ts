...
`, error);
	 ...
	 * @param BROKER_PORT
	 */
	public static kafka_start_log(BROKER_URL: string, BROKER_PORT: strnum) {
...
`, error);
	 ...
	 * @param error
	 */
	public static kafka_error_log(BROKER_URL: string, BROKER_PORT: strnum, error: IError) {
		console.error(
			`================================================================
...
`, error);
	 ...
	 * @param port
	 */
	public static grpc_start_log(port: strnum) {
		console.log(
			`================================================================
...
================================================================`);
	 ...
	 * @param error
	 */
	public static grpc_disconnect_log(port: strnum, error: Error) {
		console.log(`================================================================
