...
import {
    ...
    Comments, DeleteByObjectId, GetByObjectId, GetCommentsRequest,
    GetPostsRequest,
    GetUserPostsRequest, PostForm, PostModel,
    PostModel as IPostModel, UpdateByObjectId, VoteCommentRequest, VotePostRequest
