const StatusCode = require('../statusCodes')
    , {MongoError, MongoNetworkError} = require('mongodb')
    , {Response} = require('express')
    , {ZodError} = require('zod')
;

/**@type {{too_small: string, invalid_literal: string, invalid_arguments: string, invalid_enum_value: string, custom: string, not_finite: string, invalid_type: string, invalid_return_type: string, invalid_string: string, invalid_intersection_types: string, too_big: string, invalid_date: string, invalid_union_discriminator: string, unrecognized_keys: string, not_multiple_of: string, invalid_union: string}} */
const ZodIssueCode = {
...
/**
 * @param { MongoError | unknown} error
 * @param {Response} res
 */
function RespondMongoToError(error, res) {
    if (error instanceof MongoError) {
        /** @type {{details: string, error: string}} */
        const errorResponse = {
            error: 'Mongo Error',
            details: '',
        };
