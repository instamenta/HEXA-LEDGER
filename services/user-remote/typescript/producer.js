...
const BROKER_URL = process.env.BROKER_URL || 'redpanda-0', BROKER_PORT = process.env.BROKER_PORT || '9092', KAFKA_PRODUCER_TOPIC = process.env.KAFKA_PRODUCER_TOPIC || 'logger_topic', SnappyCodec = require('kafkajs-snappy'), Redpanda = new kafkajs_1.Kafka({ brokers: ['redpanda-0:9092'] }), Producer = Redpanda.producer();
