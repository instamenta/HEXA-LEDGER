...
interface IPostServiceService_IGetPostComments extends grpc.MethodDefinition<posts_pb.GetCommentsRequest, posts_pb.CommentModel> {
...
interface IPostServiceService_IUpvotePost extends grpc.MethodDefinition<posts_pb.VotePostRequest, google_protobuf_empty_pb.Empty> {
    path: "/post.PostService/UpvotePost";
    requestStream: false;
    responseStream: false;
    requestSerialize: grpc.serialize<posts_pb.VotePostRequest>;
    requestDeserialize: grpc.deserialize<posts_pb.VotePostRequest>;
    responseSerialize: grpc.serialize<google_protobuf_empty_pb.Empty>;
    responseDeserialize: grpc.deserialize<google_protobuf_empty_pb.Empty>;
}
interface IPostServiceService_IDownvotePost extends grpc.MethodDefinition<posts_pb.VotePostRequest, google_protobuf_empty_pb.Empty> {
...
interface IPostServiceService_IUpvoteComment extends grpc.MethodDefinition<posts_pb.VoteCommentRequest, google_protobuf_empty_pb.Empty> {
    path: "/post.PostService/UpvoteComment";
    requestStream: false;
    responseStream: false;
    requestSerialize: grpc.serialize<posts_pb.VoteCommentRequest>;
    requestDeserialize: grpc.deserialize<posts_pb.VoteCommentRequest>;
    responseSerialize: grpc.serialize<google_protobuf_empty_pb.Empty>;
    responseDeserialize: grpc.deserialize<google_protobuf_empty_pb.Empty>;
}
interface IPostServiceService_IDownvoteComment extends grpc.MethodDefinition<posts_pb.VoteCommentRequest, google_protobuf_empty_pb.Empty> {
...
export interface IPostServiceServer {
    ...
    downvotePost: grpc.handleUnaryCall<posts_pb.VotePostRequest, google_protobuf_empty_pb.Empty>;
    upvoteComment: grpc.handleUnaryCall<posts_pb.VoteCommentRequest, google_protobuf_empty_pb.Empty>;
    downvoteComment: grpc.handleUnaryCall<posts_pb.VoteCommentRequest, google_protobuf_empty_pb.Empty>;
}
...
export interface IPostServiceClient {
    ...
    upvotePost(request: posts_pb.VotePostRequest, callback: (error: grpc.ServiceError | null, response: google_protobuf_empty_pb.Empty) => void): grpc.ClientUnaryCall;
    upvotePost(request: posts_pb.VotePostRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: google_protobuf_empty_pb.Empty) => void): grpc.ClientUnaryCall;
    upvotePost(request: posts_pb.VotePostRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: google_protobuf_empty_pb.Empty) => void): grpc.ClientUnaryCall;
    downvotePost(request: posts_pb.VotePostRequest, callback: (error: grpc.ServiceError | null, response: google_protobuf_empty_pb.Empty) => void): grpc.ClientUnaryCall;
    downvotePost(request: posts_pb.VotePostRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: google_protobuf_empty_pb.Empty) => void): grpc.ClientUnaryCall;
    downvotePost(request: posts_pb.VotePostRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: google_protobuf_empty_pb.Empty) => void): grpc.ClientUnaryCall;
    upvoteComment(request: posts_pb.VoteCommentRequest, callback: (error: grpc.ServiceError | null, response: google_protobuf_empty_pb.Empty) => void): grpc.ClientUnaryCall;
    upvoteComment(request: posts_pb.VoteCommentRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: google_protobuf_empty_pb.Empty) => void): grpc.ClientUnaryCall;
    upvoteComment(request: posts_pb.VoteCommentRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: google_protobuf_empty_pb.Empty) => void): grpc.ClientUnaryCall;
    downvoteComment(request: posts_pb.VoteCommentRequest, callback: (error: grpc.ServiceError | null, response: google_protobuf_empty_pb.Empty) => void): grpc.ClientUnaryCall;
    downvoteComment(request: posts_pb.VoteCommentRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: google_protobuf_empty_pb.Empty) => void): grpc.ClientUnaryCall;
    downvoteComment(request: posts_pb.VoteCommentRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: google_protobuf_empty_pb.Empty) => void): grpc.ClientUnaryCall;
}
...
export class PostServiceClient extends grpc.Client implements IPostServiceClient {
    ...
    public upvotePost(request: posts_pb.VotePostRequest, callback: (error: grpc.ServiceError | null, response: google_protobuf_empty_pb.Empty) => void): grpc.ClientUnaryCall;
    public upvotePost(request: posts_pb.VotePostRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: google_protobuf_empty_pb.Empty) => void): grpc.ClientUnaryCall;
    public upvotePost(request: posts_pb.VotePostRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: google_protobuf_empty_pb.Empty) => void): grpc.ClientUnaryCall;
    public downvotePost(request: posts_pb.VotePostRequest, callback: (error: grpc.ServiceError | null, response: google_protobuf_empty_pb.Empty) => void): grpc.ClientUnaryCall;
    public downvotePost(request: posts_pb.VotePostRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: google_protobuf_empty_pb.Empty) => void): grpc.ClientUnaryCall;
    public downvotePost(request: posts_pb.VotePostRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: google_protobuf_empty_pb.Empty) => void): grpc.ClientUnaryCall;
    public upvoteComment(request: posts_pb.VoteCommentRequest, callback: (error: grpc.ServiceError | null, response: google_protobuf_empty_pb.Empty) => void): grpc.ClientUnaryCall;
    public upvoteComment(request: posts_pb.VoteCommentRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: google_protobuf_empty_pb.Empty) => void): grpc.ClientUnaryCall;
    public upvoteComment(request: posts_pb.VoteCommentRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: google_protobuf_empty_pb.Empty) => void): grpc.ClientUnaryCall;
    public downvoteComment(request: posts_pb.VoteCommentRequest, callback: (error: grpc.ServiceError | null, response: google_protobuf_empty_pb.Empty) => void): grpc.ClientUnaryCall;
    public downvoteComment(request: posts_pb.VoteCommentRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: google_protobuf_empty_pb.Empty) => void): grpc.ClientUnaryCall;
    public downvoteComment(request: posts_pb.VoteCommentRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: google_protobuf_empty_pb.Empty) => void): grpc.ClientUnaryCall;
}
