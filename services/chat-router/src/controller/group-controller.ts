...
export default class GroupController {
   ...
   constructor(vloggger: VLogger, service: GroupService) {
      this.vlog = vloggger.getVlog(this.constructor.name);
      this.service = service;
   }

   public static getInstance({vlogger, groupService}: IClassParams): GroupController {
      return new GroupController(vlogger, groupService);
   }
