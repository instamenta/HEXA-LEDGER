...
class AuthRouter {
   ...
   private initializeRouter() {
      ...
      this.router.post('/:userId', <any>this.auth.isAuth, <any>this.handler.createUser.bind(this.handler));
      this.router.patch('/:userId', <any>this.auth.isAuth, <any>this.auth.isUser, <any>this.handler.editUser.bind(this.handler));
   }
