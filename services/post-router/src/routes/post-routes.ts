...
POST_ROUTER.route('/comment/:commentId/upvote')
	.put(<any>isAuthenticated, <any>isOwner, <any>upvoteComment);

POST_ROUTER.route('/comment/:commentId/downvote')
	.put(<any>isAuthenticated, <any>isOwner, <any>downvoteComment);
...
POST_ROUTER.route('/users/:userId')
	.get(<any>isAuthenticated, <any>notOwner, <any>getUserPosts);
