...
function serialize_post_UpdateByObjectId(arg) {
  if (!(arg instanceof posts_pb.UpdateByObjectId)) {
    throw new Error('Expected argument of type post.UpdateByObjectId');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_post_UpdateByObjectId(buffer_arg) {
  return posts_pb.UpdateByObjectId.deserializeBinary(new Uint8Array(buffer_arg));
}
...
upvotePost: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: posts_pb.UpdateByObjectId,
    responseType: google_protobuf_empty_pb.Empty,
    requestSerialize: serialize_post_UpdateByObjectId,
    requestDeserialize: deserialize_post_UpdateByObjectId,
    responseSerialize: serialize_google_protobuf_Empty,
    responseDeserialize: deserialize_google_protobuf_Empty,
  },
  downvotePost: {
