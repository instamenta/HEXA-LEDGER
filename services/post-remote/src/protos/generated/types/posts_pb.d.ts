...
export class PostModel extends jspb.Message { 
    ...
    getTransactionsCount(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setTransactionsCount(value?: google_protobuf_wrappers_pb.Int64Value): PostModel;

    hasDonationsCount(): boolean;
    clearDonationsCount(): void;
    getDonationsCount(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setDonationsCount(value?: google_protobuf_wrappers_pb.Int64Value): PostModel;

    hasCommentsCount(): boolean;
    clearCommentsCount(): void;
    getCommentsCount(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setCommentsCount(value?: google_protobuf_wrappers_pb.Int64Value): PostModel;

    hasUpvotesCount(): boolean;
    clearUpvotesCount(): void;
    getUpvotesCount(): google_protobuf_wrappers_pb.Int64Value | undefined;
    setUpvotesCount(value?: google_protobuf_wrappers_pb.Int64Value): PostModel;

    hasDownvotesCount(): boolean;
    clearDownvotesCount(): void;
...
export namespace PostModel {
    export type AsObject = {
        ...
        transactionsCount?: google_protobuf_wrappers_pb.Int64Value.AsObject,
        donationsCount?: google_protobuf_wrappers_pb.Int64Value.AsObject,
