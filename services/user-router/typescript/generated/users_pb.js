...
proto.user.UserModel.prototype.getUserwallet = function () {
    return /** @type{?proto.user.UserWallet} */ (jspb.Message.getWrapperField(this, proto.user.UserWallet, 7));
};
/**
...
proto.user.GetUsersForm.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getIdlist();
    if (f != null) {
        writer.writeMessage(5, f, proto.user.GetUserByIdForm.serializeBinaryToWriter);
    }
};
/**
...
proto.user.GetUsersForm.prototype.getIdlist = function () {
    return /** @type{?proto.user.GetUserByIdForm} */ (jspb.Message.getWrapperField(this, proto.user.GetUserByIdForm, 5));
};
/**
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.user.UserList.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            userlistList: jspb.Message.toObjectList(msg.getUserlistList(), proto.user.UserModel.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.user.UserList.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getStatus();
    if (f != null) {
        writer.writeMessage(1, f, google_protobuf_wrappers_pb.BoolValue.serializeBinaryToWriter);
    }
    f = message.getUserlistList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(2, f, proto.user.UserModel.serializeBinaryToWriter);
    }
};
/**
...
proto.user.UserList.prototype.getStatus = function () {
    return /** @type{?proto.google.protobuf.BoolValue} */ (jspb.Message.getWrapperField(this, google_protobuf_wrappers_pb.BoolValue, 1));
};
/**
...
proto.user.UserList.prototype.getUserlistList = function () {
    return /** @type{!Array<!proto.user.UserModel>} */ (jspb.Message.getRepeatedWrapperField(this, proto.user.UserModel, 2));
};
/**
